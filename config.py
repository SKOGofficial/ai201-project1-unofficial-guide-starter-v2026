...
CHUNK_SIZE = 400        # characters per chunk — the ceiling, not a fixed width
CHUNK_OVERLAP = 100     # characters shared when one paragraph has to be split
CHUNK_MIN = 50          # anything shorter is a fragment; it gets merged, not kept
